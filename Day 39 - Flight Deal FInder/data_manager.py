...
class DataManager:
    ...
    def get_destination_data(self):
        sheet_response = requests.get(
            url="https://api.sheety.co/4ba1a538c65f852647179ea467f64ae7/copyOfFlightDeals/prices", headers=headers)
    ...
    def update_destination_codes(self):
        for data in self.destination_data:
            ...
            sheet_response = requests.put(
                url=f"https://api.sheety.co/4ba1a538c65f852647179ea467f64ae7/copyOfFlightDeals/prices/{data['id']}",
